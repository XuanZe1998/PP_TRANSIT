  ...
  <div class="account-menu">
    <template v-if="loggedIn">
      <el-dropdown trigger="click" @command="command">
        ...
        <template #dropdown><el-dropdown-menu><el-dropdown-item command="/console/profile">个人中心</el-dropdown-item><el-dropdown-item command="/console">控制台</el-dropdown-item><el-dropdown-item command="/console/keys">API Key</el-dropdown-item><el-dropdown-item command="/console/wallet">钱包充值</el-dropdown-item><el-dropdown-item command="/services">我的订单</el-dropdown-item><el-dropdown-item command="/console/docs">开发文档</el-dropdown-item><el-dropdown-item divided command="logout">退出登录</el-dropdown-item></el-dropdown-menu></template>
      </el-dropdown>
    </template>
...
<style scoped>.account-menu{display:flex;align-items:center;gap:8px}.account-trigger{display:flex;align-items:center;gap:9px;max-width:190px;padding:5px 10px 5px 5px;border:1px solid #cfe0f5;border-radius:999px;background:#f7fbff;color:#17385f;cursor:pointer}.account-trigger>span,.account-trigger img{display:grid;width:30px;height:30px;flex:0 0 30px;place-items:center;border-radius:50%;object-fit:cover;background:#deebff;color:#1254ad;font-weight:800}.account-trigger b{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}@media(max-width:680px){.account-trigger b{display:none}.account-trigger{padding-right:5px}}</style>
