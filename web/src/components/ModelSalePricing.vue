...
<style scoped>
.model-sale-pricing{display:grid;gap:10px;min-width:0;padding:12px;border:1px solid #dce7e0;border-radius:10px;background:#fbfdfb}.model-sale-pricing header{display:flex;align-items:center;justify-content:space-between;gap:10px}.model-sale-pricing header strong{color:#263c30;font-size:13px}.model-sale-pricing header span{color:#78867d;font-size:10px}.pricing-pending{display:grid;gap:4px;padding:10px;border:1px dashed #aac5eb;border-radius:8px;background:#f2f7ff}.pricing-pending strong{color:#205493;font-size:12px}.pricing-pending span{color:#657b96;font-size:10px}.sale-price-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.sale-price-grid article{display:grid;min-width:0;gap:3px;padding:8px;border-radius:8px;background:#f2f7f3}.sale-price-grid span,.sale-price-grid small{color:#6c7c72;font-size:10px}.sale-price-grid small{color:#08734f}.sale-price-grid strong{overflow-wrap:anywhere;color:#20372a;font-family:"JetBrains Mono","Cascadia Code",monospace;font-size:12px}.compact{padding:10px}.compact .sale-price-grid article{padding:7px}.compact.market-sale-pricing{gap:6px;padding:7px;border-radius:8px}.compact.market-sale-pricing header{gap:6px}.compact.market-sale-pricing header strong{font-size:11px}.compact.market-sale-pricing .sale-price-grid{gap:5px}.compact.market-sale-pricing .sale-price-grid article{gap:1px;padding:5px 6px;border-radius:6px}.compact.market-sale-pricing .sale-price-grid span,.compact.market-sale-pricing .sale-price-grid small{font-size:9px}.compact.market-sale-pricing .sale-price-grid strong{font-size:11px}.compact.market-sale-pricing .pricing-pending,.compact.market-sale-pricing .pricing-free,.compact.market-sale-pricing .unit-sale-price,.compact.market-sale-pricing .context-price-note{padding:6px}.compact.market-sale-pricing .source-price-details{padding-top:5px}@media(max-width:520px){.sale-price-grid{grid-template-columns:minmax(0,1fr)}}
