<template>
  <div class="list-pagination">
    ...
    <el-select :model-value="all ? 'all' : size" style="width: 125px" @change="resize">
      ...
      <el-option v-if="allowAll && total <= 200" value="all" label="显示全部" />
    </el-select>
...
withDefaults(defineProps<{ total: number; page: number; size: number; all?: boolean; allowAll?: boolean }>(), { allowAll: true })
