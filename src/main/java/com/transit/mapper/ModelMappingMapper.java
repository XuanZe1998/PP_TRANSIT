...
public interface ModelMappingMapper extends BaseMapper<ModelMapping> {
    ...
    String PUBLIC_COLUMNS = """
            ...
            TRUE AS available,
            MIN(NULLIF(CASE WHEN mm.billing_enabled = TRUE AND COALESCE(mm.input_price_per_million, 0) > 0 THEN COALESCE(pt.sale_input_price * CASE WHEN UPPER(COALESCE(pt.sale_price_unit, 'M')) = 'KB' THEN 1000 ELSE 1 END, mm.input_price_per_million, 0) ELSE 0 END, 0)) AS minInputPricePerMillion,
            ...
            MIN(NULLIF(CASE WHEN mm.billing_enabled = TRUE AND COALESCE(mm.input_price_per_million, 0) > 0 THEN COALESCE(pt.sale_output_price * CASE WHEN UPPER(COALESCE(pt.sale_price_unit, 'M')) = 'KB' THEN 1000 ELSE 1 END, mm.output_price_per_million, 0) ELSE 0 END, 0)) AS minOutputPricePerMillion,
            ...
            MIN(NULLIF(CASE WHEN mm.billing_enabled = TRUE AND COALESCE(mm.input_price_per_million, 0) > 0 THEN COALESCE(pt.sale_cache_read_price * CASE WHEN UPPER(COALESCE(pt.sale_price_unit, 'M')) = 'KB' THEN 1000 ELSE 1 END, mm.cached_price_per_million, 0) ELSE 0 END, 0)) AS minCachedPricePerMillion,
            ...
            MIN(NULLIF(CASE WHEN mm.billing_enabled = TRUE AND COALESCE(mm.input_price_per_million, 0) > 0 THEN COALESCE(pt.sale_cache_read_price * CASE WHEN UPPER(COALESCE(pt.sale_price_unit, 'M')) = 'KB' THEN 1000 ELSE 1 END, mm.cached_price_per_million, 0) ELSE 0 END, 0)) AS minCacheReadPricePerMillion,
            ...
            MIN(NULLIF(CASE WHEN mm.billing_enabled = TRUE AND COALESCE(mm.input_price_per_million, 0) > 0 THEN COALESCE(pt.sale_cache_write_price * CASE WHEN UPPER(COALESCE(pt.sale_price_unit, 'M')) = 'KB' THEN 1000 ELSE 1 END, 0) ELSE 0 END, 0)) AS minCacheWritePricePerMillion,
